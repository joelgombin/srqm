...
%     Fit statistics in \cmd{estout} output for \cmd{logit} models. See \texttt{help estout} and related online documentation for options.\\
%     \nhis{24,187}}
%   \end{table}%
% 
...
%     Ordinal logit model estimated with \cmd{ologit} and processed with \cmd{leanout}. See \texttt{help estout} and related online documentation for options.\\
%     \nhis{24,187}}
%   \end{table}%
%   
